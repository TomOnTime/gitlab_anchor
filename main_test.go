...
func doTestsCreateAnchor(t *testing.T, tests []string, fns []convert, fnNames []string) {
...
func TestCreate(t *testing.T) {
	...
	var funcCalls = []convert{
		markdownutils.CreateGitHubAnchor,
		markdownutils.CreateGitLabAnchor,
	}
	...
	var tests = []string{
		...
		// Input
		// Expected-from-CreateGitHubAnchor
		// Expected-from-CreateGitLabAnchor
		...
		"# Header 7",
		"-header-7",
		"-header-7", // The header is forbidden in GitLab. Result here is to placate the testing framework.
	...
	doTestsCreateAnchor(t, tests, funcCalls, funcNames)
}
